...
import { SolutionComponent } from 'app/entities/PBSx/solution/solution.component';
import { SolutionService } from 'app/entities/PBSx/solution/solution.service';
...
describe('Component Tests', () => {
  describe('Solution Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.solutions && comp.solutions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
  });
});
